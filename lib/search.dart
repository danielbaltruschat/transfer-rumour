...
class _SearchResultsState extends State<SearchResults> {
  ...
  Widget build(BuildContext context) {
    //final futurePlayers = PlayerWidget.playerWidgetFromJsonList(QueryServer.searchPlayers(widget.query));
    //final futureTeams = TeamWidget.teamWidgetFromJsonList(QueryServer.searchTeams(widget.query));
